...
.register-section {
    ...
    align-items: center;
    padding: 40px 20px;
    background: radial-gradient(circle at top left, rgba(37,99,235,0.05) 0%, rgba(248,250,252,1) 50%);
}
...
<section class="register-section">
    ...
    <div class="register-box">
        ...
        <p class="subtitle">Create an account to begin your career journey.</p>
